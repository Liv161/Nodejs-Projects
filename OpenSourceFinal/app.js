...
//*************************************************************** */
//ejs = Embedded JavaScript templates (Defines view engine)
//set views file
//*************************************************************** */
...
//**************************************************************** */
//View All Users
//Defining the URL path (This will be the homepage = user_index.ejs)
//**************************************************************** */
app.get('/',(req, res) => {
...
//**************************************************************** */
//Creating A User (This will be the Create / Add page )
//**************************************************************** */
app.get('/add',(req, res) => {
    res.render('user_add', {
        title : 'CRUD using NodeJS / ExpressJS / MySQL'
...
//***************************************************************** */
// Edit A User (This will be the Edit / Update page )
//***************************************************************** */
